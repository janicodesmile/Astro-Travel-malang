 ...
 <?php foreach($user as $u){ ?>
      <form method="post" action="<?= base_url();?>admin/edit_faq/<?= $u['id'] ?>">
        <div class="card">
            <div class="card-body">

              <div class="callout callout-warning">
                <h5>Pertanyaan</h5>
                 <textarea class="form-control" rows="5" id="konten1" name="pertanyaan"><?= $u['pertanyaan'] ?></textarea>
                <?= form_error('pertanyaan','<small class="text-danger pl-3">', '</small>'); ?>
              </div>

              <div class="callout callout-warning">
                <h5>Jawaban</h5>
                 <textarea class="form-control" rows="5" id="konten" name="jawaban"><?= $u['jawaban'] ?></textarea>
